...
_client.on('connect', c => {
    ...
    handler = _ => {
        ...
        c.send(JSON.stringify({ name: 'transaction/0x4774fEd3f2838f504006BE53155cA9cbDDEe9f0c/0xc9D50e0a571aDd06C7D5f1452DcE2F523FB711a1', type: state ? 'subscribe' : 'unsubscribe' }))
        state = !state
